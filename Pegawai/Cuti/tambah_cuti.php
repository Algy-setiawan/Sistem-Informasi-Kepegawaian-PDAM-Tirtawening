...
elseif ($jenis_cuti=='Cuti Hamil') {
 ...
 $cek = mysql_num_rows(mysql_query("SELECT * FROM cuti WHERE NIK='$NIK'"));
 if ($cek > 0){
    echo "<script>window.alert('Anda Sudah mengambil Cuti atau Tunggu Konfirmasi Admin')
    window.location='../index.php?admin=Cuti'</script>";
    }else {
