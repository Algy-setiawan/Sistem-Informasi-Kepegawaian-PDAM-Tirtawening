                  ...
                  <div class="x_content">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          value="<?php echo $_SESSION['NIK']; ?>" readonly >
...
<td>Action</td>
				...
				$a = $_SESSION['NIK'];
				$sql = mysql_query("SELECT pegawai.*,Pekerjaan.* from pegawai INNER JOIN pekerjaan on pegawai.NIK=pekerjaan.NIK WHERE pegawai.NIK='$a'");
              ...
              <td align='center'>".$data['keterangan']."</td>
							...
							<td align='center'>
							<button type='submit' class='btn btn-info'><i class='fa fa-pencil'><a href=index.php?admin=form_edit_pekerjaan&kd_pekerjaan=".$data['kd_pekerjaan']."> Edit</a></i>
