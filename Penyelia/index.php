              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="index.php?admin=home"><i class="fa fa-home"></i> Home </span></a>  
                    ...
                    <li><a href="index.php?admin=jabatan"><i class="fa fa-university"></i> Data Jabatan</span></a>  
                  </li>

                  <li><a href="index.php?admin=Pegawai"><i class="fa fa-users"></i> Data Pegawai </span></a>
                  </li>

                  <li><a href="index.php?admin=User"><i class="fa fa-user"></i> Data User </span></a>
                  </li>
                  <li><a href="index.php?admin=Cuti"><i class="fa fa-plane"></i> Pengajuan Cuti </span></a> 
                  </li>

                  <li><a href="index.php?admin=Absensi"><i class="fa fa-book"></i> Absensi </span></a>  
                  </li>
                  <li><a href="index.php?admin=Pekerjaan"><i class="fa fa-bolt"></i> Pekerjaan </span></a>  
                  </li>

                  
                  <li><a><i class="fa fa-table"></i>Laporan Pegawai<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?admin=Laporan_cuti">Laporan Cuti</a></li>
                      <li><a href="index.php?admin=Laporan_absensi">Laporan Absensi</a></li>
                      <li><a href="index.php?admin=Laporan_pekerjaan">Laporan Pekerjaan</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
  ...
  if(isset($_GET['admin'])){
    ...
    switch ($page) {
      ...
      case 'Absensi':
        ...
        break; 
      case 'form_edit_absensi':
        include "absensi/form_edit_absensi.php";
        break; 
      case 'view':
      ...
      case 'Cuti':
        ...
        break; 
      case 'view_diterima_cuti':
        include "Cuti/view_diterima_cuti.php";
        break;
      case 'view_ditolak_cuti':
        include "Cuti/view_ditolak_cuti.php";
        break;
      case 'Pekerjaan':
        include "Pekerjaan/index.php";
        break; 
      case 'Laporan_cuti':
        include "Laporan/laporan_cuti.php";
        break;
      case 'Laporan_absensi':
        include "Laporan/laporan_absensi.php";
        break;
      case 'Laporan_pekerjaan':
        include "Laporan/laporan_pekerjaan.php";
        break;  
